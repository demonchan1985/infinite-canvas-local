...
export function ModelPicker({ config, value, onChange, capability, className, fullWidth = false, placeholder, onMissingConfig }: ModelPickerProps) {
    ...
    return (
        ...
        >
            <SelectTrigger
                className={cn(
                    "canvas-composer-model-picker h-12 w-fit max-w-full gap-2 rounded-full border border-input bg-transparent px-4 text-[16px] font-normal shadow-sm transition-colors",
