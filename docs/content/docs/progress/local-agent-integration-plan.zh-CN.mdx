...
网页侧边栏填写或自动发现 `http://127.0.0.1:17376` 和 token 后连接本机服务。
...
```txt
网页 -> http://127.0.0.1:17376/events?token=xxx
网页 -> http://127.0.0.1:17376/canvas/state?token=xxx
网页 -> http://127.0.0.1:17376/canvas/result?token=xxx
```
